...
class RegionNormalizer:
    ...
    def __init__(self):
        # Dicionário de mapeamentos: tag_normalizada -> RegionMapping
        self.tag_mappings: Dict[str, RegionMapping] = {}
    ...
    def _initialize_default_mappings(self):
        ...
        self.add_mapping("BR", {
            "brasil", "brazil", "br", "brasileiro", "brazilian"
        })

        self.add_mapping("SA", {
            "south america", "southamerica", "sa"
        })

        self.add_mapping("NA", {
            "usa", "united states", "en", "north america", "north-america", "northamerica",
            "us", "us1", "us2", "us3", "us4", "us5"
        })

        self.add_mapping("OC", {
            "oceania", "oc", "au", "australia", "au1", "au2", "au3"
        })
    ...
    def add_mapping(self, canonical_tag: str, variations: Set[str], threshold: int = 85):
        ...
        if canonical_tag in self.tag_mappings:
            ...
            self.tag_mappings[canonical_tag] = RegionMapping(
