...
public class ReviewController {
    ...
    public ResponseEntity<?> createReview(
        ...
        return ResponseEntity.ok().body(feedbackMapper.success("REVIEW_SUCCESS_POSTED"));
    }

    @GetMapping("/{networkId}")
    public ResponseEntity<List<ReviewDisplayDTO>> getReview(@PathVariable UUID networkId) {
        return ResponseEntity.ok().body(reviewService.getAllReviewsDisplay(networkId));
    }
