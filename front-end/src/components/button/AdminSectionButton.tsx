...
export const AdminSectionButton: React.FC<AdminSectionButton> = ({ title, description, Icon, details, onClick}) => {
    return (
      <div 
        className="bg-slate-900 px-6 py-5 rounded-xl gap-3 flex flex-col cursor-pointer hover:scale-102 transition-all"
        onClick={onClick}
      >
        <div className="flex flex-row gap-3 items-center">
          <div className="bg-blue-600 p-3 rounded-md aspect-square flex h-15 justify-center items-center">
